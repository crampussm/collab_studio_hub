...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    if (loginMode === "creator") {
      console.log(credentials.emailorusername, credentials.password);
      ...
      <div className='flex justify-center '>
        <div className="login-box flex flex-col font-csh items-center w-[80%] rounded-md md:w-1/3" style={{ boxShadow: "rgba(0, 0, 0, 0.1) 0px 1px 3px 0px, rgba(0, 0, 0, 0.06) 0px 1px 2px 0px" }}>
          ...
          <form action="" onSubmit={handleLogin} className='flex flex-col w-full p-6'>
            <div>
              <label htmlFor="emailorusername" className='my-5 font-csh'>Email</label>
              <input type="text" id='emailorusername' className='border-2 bg-cshoffwhite rounded-md w-full h-[35px] py-2 px-2' name='emailorusername' value={credentials.emailorusername} onChange={onChange} required/>
